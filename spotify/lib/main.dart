...
Future<void> main() async {
  ...
  runApp(const MyApp()); // runApp() is a built-in Flutter function that takes a Widget as its argument and makes it the root of the widget tree. In this case, it takes an instance of MyApp
}
